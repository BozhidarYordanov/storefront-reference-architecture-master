    ...
    function (req, res, next) {
        ...
        if (!showProductPageHelperResult.product.online && productType !== 'set' && productType !== 'bundle') {
            ...
            if (pageLookupResult.page) {
                ...
                //gets the notifyForm form object and the content assets
                var buttonAsset = dw.content.ContentMgr.getContent('open-modal-button');
                var headerAsset = dw.content.ContentMgr.getContent('back-in-stock-modal-title');
                ...
                res.render(showProductPageHelperResult.template, {
                    ...
                    notifyForm: notifyForm,         //pass the notifyForm form object and the content assets
                    buttonAsset: buttonAsset,       // to the template
